    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo_author', models.ImageField(blank=True, null=True, upload_to=None)),
                ('photo_book', models.ImageField(blank=True, null=True, upload_to=None)),
                ...
                ('status', models.CharField(blank=True, choices=[('availbale', 'availbale'), ('rented', 'rented'), ('sold', 'sold')], max_length=50, null=True)),
